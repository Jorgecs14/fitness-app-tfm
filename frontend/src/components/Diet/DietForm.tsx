// Modal de creación y edición integral de Dietas con diseño Apple Liquid Glass y máxima claridad visual
  ...
  return (
    ...
    >
        ...
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          <Box>
            ...
            <Typography variant="caption" sx={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '0.78rem' }}>
              Hidratación diaria, 5 tomas de comidas y suplementación recomendada
            </Typography>
          </Box>
        </Stack>
          ...
          <Stack spacing={3}>
            ...
            >
              ...
              <Stack spacing={2.5}>
                <Box>
                  ...
                  <TextField
                    fullWidth
                    placeholder="Ej: Dieta de Definición 2.200 kcal, Plan Rendimiento"
                    value={name}
              ...
              <Stack direction="row" spacing={1.5} alignItems="center" mb={1.5}>
                ...
                <Box>
                  ...
                  <Typography variant="caption" sx={{ color: 'rgba(255, 255, 255, 0.65)' }}>
                    Cantidad diaria de agua en Litros que se sincronizará con el perfil y tracker del cliente
                  </Typography>
                </Box>
              </Stack>
            ...
            >
              ...
              <TextField
                ...
                multiline
                rows={3}
                placeholder="Pautas sobre cocinado, sal, descansos o cómo distribuir las comidas a lo largo de la jornada..."
                value={generalNotes}
                  ...
                  {currentFoods.length === 0 ? (
                    <Box sx={{ p: 3.5, textAlign: 'center', borderRadius: '16px', bgcolor: 'rgba(255, 255, 255, 0.02)', border: '1px dashed rgba(255, 255, 255, 0.12)' }}>
                      <Typography variant="body2" sx={{ color: 'rgba(255, 255, 255, 0.5)' }}>
                        No hay alimentos añadidos a {currentMealDef.label}. Selecciónalos en el formulario de arriba.
                      </Typography>
                    </Box>
                  ) : (
                    <Stack spacing={1}>
      ...
      >
        ...
        >
          {dietToEdit ? 'Guardar Cambios' : 'Crear Pauta Nutricional'}
        </Button>
      </DialogActions>
    </Dialog>
  );
