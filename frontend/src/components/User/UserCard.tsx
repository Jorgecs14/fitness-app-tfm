      ...
      <CardContent sx={{ flexGrow: 1, p: 3 }}>
        ...
        <Stack spacing={1} sx={{ mb: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Iconify icon="eva:email-outline" sx={{ width: 16, height: 16, color: 'text.secondary' }} />
          ...
          {user.birth_date && (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <Iconify icon="eva:calendar-outline" sx={{ width: 16, height: 16, color: 'text.secondary' }} />
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <Iconify icon="eva:clock-outline" sx={{ width: 16, height: 16, color: 'text.secondary' }} />
            <Typography variant="body2" color="text.secondary">
