...
export const UserList = ({ users, loading, onEdit, onDelete, onExport, onCreateNew }: UserListProps) => {
          ...
          <Table sx={{ minWidth: { xs: 600, md: 'auto' } }}>
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ display: { xs: 'none', sm: 'table-cell' } }}>Fecha Nacimiento</TableCell>
